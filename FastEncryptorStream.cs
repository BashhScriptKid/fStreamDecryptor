...
public class FastEncryptorStream : Stream
{
    ...
    private readonly SafeEncryptionProvider FastEncryptionProvider = new SafeEncryptionProvider();
    ...
    public FastEncryptorStream(Stream InternalStream, fEnum.EncryptionMethod EM, uint[] Key)
    {
